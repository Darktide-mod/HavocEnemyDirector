...
Open Havoc Enemy Director from Mod Options, or open Detailed tuning in the local-game settings. The five sections are Director, Formation library, Deployment rules, Native templates, and Presets & changes.
