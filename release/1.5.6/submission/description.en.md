...
A deleted travel generator can return after a difficulty change because some generator identifiers depend on difficulty. This remains unresolved in 1.5.6. Recheck the compiled generator list after changing difficulty; the mod should not be relied upon to enforce a Boss-only run.
