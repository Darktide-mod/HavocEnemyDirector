...
local len=win.MultiByteToWideChar(65001,8,path,#path,nil,0)
local wide=ffi.new("unsigned short[?]",len+1);win.MultiByteToWideChar(65001,8,path,#path,wide,len)
local lock=win.CreateFileW(wide,2147483648,1,nil,3,128,nil)
