...
with (CHECKS/'tests.log').open('w',encoding='utf-8') as log:
    for case in ['syntax_tests.py', 'native_preset_tests.py', 'native_relative_tests.py', 'director_tests.py', 'director_spawning_tests.py', 'director_ui_tests.py', 'release_debug_tests.py']:
